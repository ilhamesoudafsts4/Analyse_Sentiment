...
tv = TfidfVectorizer(binary=False, min_df=0.0, max_df=1.0, ngram_range=(1, 2))
...
plt.ylabel('true')
plt.savefig('C:/Users/net/Desktop/sentiment-analysis-master/sentiment-analysis/results/ml_confusion_matrix.png', format='png', transparent=False)  # save result
plt.show()
...
tv_metrics.to_csv('.C:/Users/net/Desktop/sentiment-analysis-master/sentiment-analysis/results/results/ml_performance_result.csv', index=None, header=True)
