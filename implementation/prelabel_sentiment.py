...
# load dataset
filename = 'C:/Users/net/Desktop/sentiment-analysis-master/sentiment-analysis/datasets/prepared_amazon_unlocked_mobile_datasets.csv'
names = ['product.name', 'brand.name', 'review.text', 'review.process', 'review.tokened']
review = pd.read_csv(filename, names=names)
review['review.tokened'].value_counts(sort = False)
# drop null values
...
filename = r'C:\Users\net\Desktop\sentiment-analysis-master\sentiment-analysis\datasets\amazon_unlocked_mobile_datasets_with_sentiment.csv'
